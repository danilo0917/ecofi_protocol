...
contract Ecofi is ERC20Detailed, Ownable, MinterRole {
    ...
    uint256 public totalFee = liquidityFee.add(treasuryFee).add(riskFreeValueFee).add(devFee);
    ...
    constructor(
    ...
    ) ERC20Detailed("Ecofi", "ECOFI", uint8(DECIMALS)) {
        ...
        devAddress = 0x639670bEc0d40fD8A32e2f591C956dEDeb880FA3;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountETHdevfee = amountETH.mul(devFee).div(totalETHFee);
